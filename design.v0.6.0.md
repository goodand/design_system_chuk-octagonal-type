...
version: 0.6.0
companion: design-extension.v0.6.0.md
authors:
  - STITCH (Color & Symbol Specialist Agent)
  - Chuk Design Team
changelog:
  v0.6.0:
    - "fontFamily.sans synced with HTML: 'Pretendard Variable', Pretendard, ..."
    - "fontFamily.mono explicit system stack"
    - "accent token comment delegates to design-extension.v0.6.0.md → accent_scope"
    - "body weight standardized at 400 (was inconsistent 300/400 in v0.5.x)"
notes: |
  ...
  harmony test outcomes, system rules R1–R9, accent_scope, contrast_table,
  r9_operating_rules) lives in `design-extension.v0.6.0.md`.

# ── COLORS ─────────────────────────────────────────────────────
# CORE 8 tokens — agreed in DS v0.5 + Harmony Test (8/8 PASS).
# MD3 surface/role slots are NOT adopted here; they are tracked
# in design-extension.v0.6.0.md under `colors_pending_review`.
# accent token has dual semantic scope (accent_symbol vs accent_ui)
# defined in design-extension.v0.6.0.md → accent_scope.
colors:
  ...
  bg:          '#f4f3ef'   # page surface (canonical — bg-canonical decision 2026-04-27)
  paper:       '#faf9f5'   # raised cards · stages
  accent:      '#d9531e'   # see design-extension.v0.6.0.md → accent_scope
...
# v0.6.0: font stack now matches HTML 1:1.
typography:
  display-hero:
